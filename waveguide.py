...
# fig = geom.plot_domain([np.array([0.0]),np.array([-0.0]),np.array([0.0]),np.array([0.0])],[(0,1),(0,1),(0.0,1)],surface_color=None, wireframe = False, alpha = 0.1, n = 64, frame_color = None)
# geom.plot_domain([np.array([Basis_param[0].interval[0]]),np.array([Basis_param[1].interval[0]]),np.array([Basis_param[2].interval[0]]), np.array([0]) ],[(0,1),(0,1),(0.0,1)],fig = fig,surface_color='blue', wireframe = False,alpha=0.01,n=64)
# geom.plot_domain([np.array([Basis_param[0].interval[0]]),np.array([Basis_param[1].interval[0]]),np.array([Basis_param[2].interval[1]]), np.array([0]) ],[(0,1),(0,1),(0.0,1)],fig = fig,surface_color='blue', wireframe = False,alpha=0.01,n=64)
# geom.plot_domain([np.array([Basis_param[0].interval[0]]),np.array([Basis_param[1].interval[1]]),np.array([Basis_param[2].interval[0]]), np.array([0]) ],[(0,1),(0,1),(0.0,1)],fig = fig,surface_color='blue', wireframe = False,alpha=0.01,n=64)
# geom.plot_domain([np.array([Basis_param[0].interval[0]]),np.array([Basis_param[1].interval[1]]),np.array([Basis_param[2].interval[1]]), np.array([0]) ],[(0,1),(0,1),(0.0,1)],fig = fig,surface_color='blue', wireframe = False,alpha=0.01,n=64)
# geom.plot_domain([np.array([Basis_param[0].interval[1]]),np.array([Basis_param[1].interval[0]]),np.array([Basis_param[2].interval[0]]), np.array([0]) ],[(0,1),(0,1),(0.0,1)],fig = fig,surface_color='blue', wireframe = False,alpha=0.01,n=64)
# geom.plot_domain([np.array([Basis_param[0].interval[1]]),np.array([Basis_param[1].interval[0]]),np.array([Basis_param[2].interval[1]]), np.array([0]) ],[(0,1),(0,1),(0.0,1)],fig = fig,surface_color='blue', wireframe = False,alpha=0.01,n=64)
# geom.plot_domain([np.array([Basis_param[0].interval[1]]),np.array([Basis_param[1].interval[1]]),np.array([Basis_param[2].interval[0]]), np.array([0]) ],[(0,1),(0,1),(0.0,1)],fig = fig,surface_color='blue', wireframe = False,alpha=0.01,n=64)
# geom.plot_domain([np.array([Basis_param[0].interval[1]]),np.array([Basis_param[1].interval[1]]),np.array([Basis_param[2].interval[1]]), np.array([0]) ],[(0,1),(0,1),(0.0,1)],fig = fig,surface_color='blue', wireframe = False,alpha=0.01,n=64)
# geom.plot_domain([np.array([0]),np.array([0]),np.array([0]), np.array([0]) ],[(0,1),(0,1),(0.0,1)],fig = fig,surface_color='blue', wireframe = False,alpha=0.01,n=64, frame_color = 'k')
# fig.gca().set_xlabel(r'$x_1$')
# fig.gca().set_ylabel(r'$x_2$')
# fig.gca().set_zlabel(r'$x_3$')
# fig.gca().view_init(15, -60)
